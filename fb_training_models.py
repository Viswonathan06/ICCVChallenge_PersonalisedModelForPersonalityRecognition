# -*- coding: utf-8 -*-
"""FB Training Models.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wU9U--9o_Pt8B0I88Qyh-HAbnr6qGTKj
"""
...
# Reading files. 
df_train=pd.read_csv('/mnt/CSV files/train_data.csv')
df_validation=pd.read_csv('/mnt/CSV files/validation_data.csv')
df_test=pd.read_csv('/mnt/CSV files/test_data.csv')
...
for i in range(5):
  ...
  print(model_names[i])
  # Define a regressor
  total_reg = ak.StructuredDataRegressor(max_trials=100, overwrite=True,project_name = 'male'+model_names[i], directory = '/mnt/Dump Data')
  ...
  with open('/mnt/Dump Data/male_eval_val.txt', 'a') as f:
      f.write('male'+model_names[i]+' -> ')
      f.write(str(evaluation))
      f.write('\n')
  # Save current model
  total_model.save('/mnt/NewlyTrainedModels/'+model_names[i])
...
for i in range(5):
  ...
  # Define a regressor
  total_reg = ak.StructuredDataRegressor(max_trials=100, overwrite=True,project_name = 'female'+model_names[i], directory = '/mnt/Dump Data')
  # Feed the tensorflow Dataset to the regressor.
  total_reg.fit(train, epochs=1000, validation_split=0.25)
  # Convert to model   
  total_model = total_reg.export_model()
  ...
  evaluation = total_reg.evaluate(val)
  # Write loss and error to a file
  with open('/mnt/Dump Data/female_eval_val.txt', 'a') as f:
